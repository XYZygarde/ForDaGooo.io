...
function initMap() {
    map = new Microsoft.Maps.Map('.mapcontainer', {
        credentials: bingApi,
        center: new Microsoft.Maps.Location(14.6528615, 121.0452145),
...
function renderTable() {
    ...
    placeData.forEach((record, i = 0) => {
        ...
        row.innerHTML = `
            ...
            <td>
                <img onclick="editCoordination(${i})" src="FDG_img/fdg-editbtn.png" class="icon-action" alt="Edit">
                <img onclick="viewCoordination(${i})" src="FDG_img/fdg-viewbtn.png" class="icon-action" alt="View">
                <img onclick="measurePoints(${i})" src="FDG_img/fdg-measurebtn.png" class="icon-action-this" id="" alt="Measure">
                <img onclick="delCoordination(${i}, '${record.namelabel}')" src="FDG_img/fdg-deletebtn.png" class="icon-action" alt="Delete">
            </td>
        `;
...
function delCoordination(index, label, pincolor = 'red') {
    const pushpinIndex = delpushpins.findIndex(p => p.label === label && p.pincolor === pincolor);
